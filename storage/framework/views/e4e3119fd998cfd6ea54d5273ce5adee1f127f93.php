				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							<a href="<?php echo e(url('/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('assets/img/brand/hat.png')); ?>" class="logo-1" alt="logo"></a>
							<a href="<?php echo e(url('/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('assets/img/brand/hat.png')); ?>" class="dark-logo-1" alt="logo"></a>
							<a href="<?php echo e(url('/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('assets/img/brand/hat.png')); ?>" class="logo-2" alt="logo"></a>
							<a href="<?php echo e(url('/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('assets/img/brand/hat.png')); ?>" class="dark-logo-2" alt="logo"></a>
						</div>
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href="">
                                    <img alt="" src="<?php echo e(URL::asset('assets/img/faces/6.jpg')); ?>">
                                </a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											...
											<div class="mr-3 my-auto">
												<h6><?php echo e($user->fullName()); ?></h6><span><?php echo e($user->role); ?></span>
											</div>
										</div>
									</div>
									
									<a class="dropdown-item" href="<?php echo e(route('logout')); ?>"><i class="bx bx-log-out"></i>Sign Out</a>
								</div>
							</div>
...
<!-- /main-header -->
<?php /**PATH /opt/lampp/htdocs/freelance/Nokhba(Dev)/resources/views/dashbord/layouts/main-header.blade.php ENDPATH**/ ?>