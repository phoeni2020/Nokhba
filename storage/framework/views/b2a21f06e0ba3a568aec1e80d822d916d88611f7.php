        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card-body pb-0">
                    ...
                    <?php endif; ?>
                    <div class="card">
                        <form action="<?php echo e(route('admin.store.assitant')); ?>" method="post" >
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
...
<?php echo $__env->make('dashbord.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/freelance/Nokhba(Dev)/resources/views/dashbord/teachers/asstitant/create.blade.php ENDPATH**/ ?>