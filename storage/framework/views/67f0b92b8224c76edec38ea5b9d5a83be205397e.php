							...
							<div class="card-body">
								...
								<div class="d-flex flex-wrap">
									<div class="flex-1 pos-relative">
										<img alt="" class="wd-100p ht-100p object-fit-cover" src="<?php echo e(URL::asset('assets/img/photos/5.jpg')); ?>">
...
<?php echo $__env->make('dashbord.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/freelance/Nokhba(Dev)/resources/views/dashbord/background.blade.php ENDPATH**/ ?>