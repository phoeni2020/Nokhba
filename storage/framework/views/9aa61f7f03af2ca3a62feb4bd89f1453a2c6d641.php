							...
							<div class="card-body">
								...
								<div class="row mb-4">
									...
									<div class="col-sm-12 col-md-4 mg-t-10 mg-sm-t-0">
										<input type="file" class="dropify" data-default-file="<?php echo e(URL::asset('assets/img/photos/1.jpg')); ?>" data-height="200"  />
									</div>
									<div class="col-sm-12 col-md-4 mg-t-10 mg-sm-t-0">
...
<?php echo $__env->make('dashbord.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/freelance/Nokhba(Dev)/resources/views/dashbord/form-advanced.blade.php ENDPATH**/ ?>