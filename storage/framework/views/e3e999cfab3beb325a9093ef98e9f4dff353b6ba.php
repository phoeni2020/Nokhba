<?php if($user->role == 'admin'): ?>
    ...
    <aside class="app-sidebar sidebar-scroll">
        <div class="main-sidebar-header active">
            <a class="desktop-logo logo-light" href="<?php echo e(url('/' . $page='index')); ?>">
                <img src="<?php echo e(URL::asset('assets/img/brand/BeFunky-design.png')); ?>" class="main-logo" alt="logo">
            </a>
            <a class="desktop-logo logo-dark active" href="<?php echo e(url('/admin/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('assets/img/brand/hat.png')); ?>" class="main-logo dark-theme" alt="logo"></a>
            <a class="logo-icon mobile-logo icon-light active" href="<?php echo e(url('/admin/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('assets/img/brand/hat.png')); ?>" class="logo-icon" alt="logo"></a>
            <a class="logo-icon mobile-logo icon-dark active" href="<?php echo e(url('/admin/' . $page='index')); ?>"><img src="<?php echo e(URL::asset('assets/img/brand/hat.png')); ?>" class="logo-icon dark-theme" alt="logo"></a>
        </div>
        <div class="main-sidemenu">
            <div class="app-sidebar__user clearfix">
                <div class="dropdown user-pro-body">
                    ...
                    <div class="user-info">
                        <h4 class="font-weight-semibold mt-3 mb-0"><?php echo e(auth()->user()->fullName()); ?></h4>
                    </div>
                </div>
            </div>
            <ul class="side-menu">
                <li class="slide">
                    <a class="side-menu__item" href="<?php echo e(route('admin.dashbord')); ?>">
                        <ion-icon class="side-menu__icon fa fa-list-alt"></ion-icon>
                        <span class="side-menu__label"> الصفحة الرئيسيه </span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="<?php echo e(route('admin.catgory.index')); ?>">
                        <ion-icon class="side-menu__icon fa fa-list-alt"></ion-icon>
                        <span class="side-menu__label">التصنيفات</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="<?php echo e(route('admin.course.index')); ?>">
                        <i class="fas fa-atom side-menu__icon"></i>
                        <span class="side-menu__label">كورسات</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="<?php echo e(route('admin.qrcode.index')); ?>">
                        <i class="fas fa-qrcode side-menu__icon"></i>
                        <span class="side-menu__label">QRCodes</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="<?php echo e(route('admin.attach.index')); ?>">
                        <i class="fas fa-paperclip side-menu__icon"></i>
                        <span class="side-menu__label">المرفقات</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="<?php echo e(route('admin.notifications.index')); ?>">
                        <i class="far fa-bell side-menu__icon "></i>
                        <span class="side-menu__label">اﻻشعارات</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="<?php echo e(route('admin.students.index')); ?>">
                        <i class="fas fa-user-graduate side-menu__icon"></i>
                        <span class="side-menu__label">الطلبه</span>
                    </a>
                </li>
                <li class="slide">
                    <a class="side-menu__item" href="<?php echo e(route('admin.exam.index')); ?>">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li>
                            <a class="slide-item" href="<?php echo e(route('admin.add.assitant')); ?>">
                                <i class="fas fa-user-plus"></i>
                                اضافه المساعدين
                            </a>
                        </li>
                        <li>
                            <a class="slide-item" href="<?php echo e(route('admin.teachers.settings')); ?>">
                                <i class="fas fa-cogs side-menu__icon"></i>
                                اعدادت اﻻستاذ
                            </a>
                        </li>
                        <li>
                            <a class="slide-item" href="<?php echo e(route('admin.teachers.links.index')); ?>">
                                <i class="fas fa-link side-menu__icon"></i>
                                طرق الدفع و الروابط
                            </a>
                        </li>
                        <li>
                            <a class="slide-item" href="<?php echo e(route('admin.teachers.center.index')); ?>">
                                <i class="fas fa-link side-menu__icon"></i>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li>
                            <a class="slide-item" href="<?php echo e(route('admin.app.developer.settings')); ?>">
    ...
    <aside class="app-sidebar sidebar-scroll">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="<?php echo e(url('/admin/' . $page='#')); ?>">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li>
                            <a class="side-menu__item" href="<?php echo e(route('admin.teachers.settings')); ?>">
                                <i class="fas fa-cogs side-menu__icon"></i>
...
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/freelance/Nokhba(Dev)/resources/views/dashbord/layouts/main-sidebar.blade.php ENDPATH**/ ?>