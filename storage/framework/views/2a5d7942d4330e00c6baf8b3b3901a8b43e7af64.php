        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card-body pb-0">
                    ...
                    <?php endif; ?>
                    <div class="card">
                        <form action="<?php echo e(route('admin.category.update',$catgory->id)); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                                ...
                                <div class="pd-30 pd-sm-40 bg-gray-200">
                                    <div class="row row-xs align-items-center mg-b-20">
                                        ...
                                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                                            <input class="form-control" placeholder="Enter Category Name" name="name" value="<?php echo e($catgory['name']); ?>" type="text">
                                        </div>
                                    </div>
                                    <div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-8 mg-t-5 mg-md-t-0">
                                            <textarea class="form-control" name="desc" id="" cols="30" rows="10"><?php echo e($catgory['desc']); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="row row-xs align-items-center mg-b-20">
                                        <div class="col-md-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pd-30 pd-sm-40 ">
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="row row-sm mb-5">
                                                ...
                                                <div class="col-md-3 mg-t-2 mg-md-t-0">
                                                    <input type="checkbox" name="main" <?php echo e($catgory['main'] ==0 ? 'checked':''); ?>>
                                                </div>
                                    ...
                                    <div class="form-group col-md-10 col-sm-6 col-xs-12">
                                        <fieldset>
                                            ...
                                            <div class="row row-sm mb-5">
                                                ...
                                                >
                                                    <select class="js-example-basic-single form-control category" name="main_cat" id="main">
                                                            <?php if($catgory['is_parent'] == 1  && $catgory['main'] != 0): ?>
                                                                <option value="<?php echo e($catgory['main']); ?>"><?php echo e($catgory->mainCategories->name); ?></option>
                                                            <?php endif; ?>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="row row-sm mb-5">
                                                ...
                                                <div class="col-lg-3 mg-t-2 mg-md-t-0">
                                                    <select class="js-example-basic-single form-control category" name="parent" >
                                                        <?php if($catgory['is_parent'] != 0 &&$catgory['parent'] !=0 ): ?>
                                                            <option value="<?php echo e($catgory['parent']); ?>"><?php echo e($catgory->parentCategories->name); ?></option>
                                                        <?php endif; ?>
                                                    </select>
                                                </div>
                                                <div class="col-lg-6 mg-t-2 mg-md-t-0">
                                            ...
                                            <div class="row row-sm mb-5">
                                                ...
                                                <div class="col-md-3 mg-t-2 mg-md-t-0">
                                                    <input type="checkbox" name="is_parent" <?php echo e($catgory['is_parent']==1 && $catgory['main'] !=0 ?'checked':''); ?> >
                                                </div>
                                                <div class="col-md-6 mg-t-2 mg-md-t-0">
                                                    <p>
                                    ...
                                    <a href="<?php echo e(route('admin.catgory.index')); ?>">
...
<?php echo $__env->make('dashbord.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/freelance/Nokhba(Dev)/resources/views/dashbord/catgory/edit.blade.php ENDPATH**/ ?>