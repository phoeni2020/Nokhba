...
<?php $__env->startSection('content'); ?>
		...
		<div class="main-error-wrapper  page page-h ">
			...
			<h6>You may have mistyped the address or the page may have moved.</h6><a class="btn btn-outline-danger" href="<?php echo e(is_null(auth()->user()) ? url('/login'):route('admin.dashbord')); ?>">Back to Home</a>
		</div>
		<!-- /Main-error-wrapper -->
<?php $__env->stopSection(); ?>
...
<?php echo $__env->make('dashbord.layouts.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/freelance/Nokhba(Dev)/resources/views/dashbord/404.blade.php ENDPATH**/ ?>