...
<?php $__env->startSection('page-header'); ?>
    <div class="container-fluid">
        <div class="breadcrumb-header justify-content-between">
            <div class="my-auto">
                <div class="d-flex">
                    <h4 class="content-title mb-0 my-auto">Upload New Attchment</h4>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <form action="<?php echo e(route('admin.attach.store')); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div id="holder">
                                <div class="card-body A">
                                    <h3 class="mg-b-20">Information About Attchment</h3>
...
<?php echo $__env->make('dashbord.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/freelance/Nokhba(Dev)/resources/views/dashbord/attach/create.blade.php ENDPATH**/ ?>