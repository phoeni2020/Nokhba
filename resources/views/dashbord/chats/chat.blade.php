...
<div class="col-xl-8 col-lg-7">
    <div class="card">
                ...
                <nav class="nav">
                    <a class="nav-link" href=""><i class="icon ion-md-more"></i></a> <a class="nav-link"
                            ...
                            class="icon ion-ios-filing"></i></a> <a class="nav-link" data-toggle="tooltip" href=""
                                                                    title="Trash"><i class="icon ion-md-trash"></i></a>
            ...
            <div class="main-chat-body" id="ChatBody">
                <div class="content-inner">
                    ...
                    <div class="media flex-row-reverse">
                        <div class="main-img-user online"><img alt="" src="{{URL::asset('assets/img/faces/9.jpg')}}">
                        </div>
                    ...
                    <div class="media">
                        <div class="main-img-user online"><img alt="" src="{{URL::asset('assets/img/faces/6.jpg')}}">
                        </div>
                        <div class="media-body">
                    ...
                    <div class="media flex-row-reverse">
                        ...
                        <div class="media-body">
                            <div class="main-msg-wrapper right">
                                ...
                                massa quis enim. Donec pede justo, fringilla vel, aliquet nec. In enim justo, rhoncus
        ...
        <div class="main-chat-footer">
            ...
            <input class="form-control" placeholder="Type your message here..." type="text"> <a class="main-msg-send"
                                                                                                href=""><i
