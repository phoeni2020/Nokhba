...
@section('content')
		...
		<div class="main-error-wrapper  page page-h ">
			...
			<h6>You may have mistyped the address or the page may have moved.</h6><a class="btn btn-outline-danger" href="{{is_null(auth()->user()) ? url('/login'):route('admin.dashbord') }}">Back to Home</a>
		</div>
		<!-- /Main-error-wrapper -->
@endsection
@section('js')
